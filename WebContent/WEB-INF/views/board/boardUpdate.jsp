			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="page-header">
						<h3 class="page-title kor">
							<span style="float: left;"> <i
								class="mdi mdi-chevron-left back" onclick="boardView();"></i>
							</span> <span
					...
					<section id="board-container">
						<form action="<%=request.getContextPath()%>/board/boardUpdate"
							method="post" enctype="multipart/form-data">
							<input type="hidden" name="boardNo" value="<%=b.getBoardNo()%>" />
							<div class="col-lg-12 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
										<table id="tbl-board-view" class="table"
											...
											<tr>
												<td><input type="text" name="boardWriter"
													class="form-control form-control-lg"
													value="<%=b.getBoardWriter()%>" readonly required /></td>
											</tr>
											<tr>
												<td style="position: relative;"><input type="file"
													name="upFile" style="margin: 0px 30px;" /> <span id="fname"><%=b.getBoardOriginalFileName() != null ? b.getBoardOriginalFileName() : ""%></span>
													...
													%> <span
													class="form-check"
													style="display: inline; margin: 10px 30px;"> <label
														for="delFile" class="form-check-label"
														style="display: inline; font-size: 13px;"> <input
															type="checkbox" name="delFile" id="delFile"
															class="form-check-input" style="margin-top: 10px;" />
															첨부파일 삭제 </span> <%
 }
 %></td>
											</tr>
											<tr>
												<td><textarea name="boardContent" class="form-control"
														cols="50" rows="5"><%=b.getBoardContent()%></textarea></td>
											</tr>
											<tr>
												<th colspan="2" style="text-align: center;">
													<button type="submit" value="수정하기"
														class="btn btn-primary btn-fw"
														onclick="return boardValidate();">수정하기</button>
													<button type="button" value="취소"
														class="btn btn-danger btn-fw" onclick="boardView();">취소</button>
												</th>
											</tr>
										</table>
									</div>
