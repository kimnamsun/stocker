							...
							<div class="card-body">
								<form action="<%=request.getContextPath() %>/board/boardInsert"
									...
									<table id="tbl-board-view" class="table"
										...
										<tr>
											<td><input style="border: 0px;" type="text"
												class="form-control form-control-lg writer"
												name="boardWriter" value="<%= empLoggedIn.geteName() %>"
												readonly /></td>
										</tr>
										<tr>
											<td><input type="file" name="upFile"
												class="file-upload-default" style="margin: 0px 35px;">
											</td>
										</tr>
										<tr>
											<td><textarea rows="5" cols="40" name="boardContent"
										...
										<tr>
											<th colspan="2" style="text-align: center;">
												<button type="submit" value="등록하기"
													...
													onclick="return boardValidate();">등록하기</button>
											</th>
										</tr>
									</table>
								</form>
