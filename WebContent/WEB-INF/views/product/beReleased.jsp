						...
						<div class="card">
							<div class="card-body">
								<form class="form-sample" id="searchForm"
									action="<%= contextPath %>/beReleased/search">
									<div class="row">
										<div class="col-md-6">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<button type="button" class="btn btn-inverse-info btn-fw"
												style="float: left"
												onclick="location.href='<%= contextPath %>/product/beReleased'">전체보기</button>
										</div>
										<div class="col-md-6">
							...
							<div class="col-12 grid-margin" style="margin-top: 26px">
                       		...
                       		for(BeReleased br : brList) {%>
													...
													<tr>
														...
														<td><label class="badge badge-gradient-danger">매장출고</label>
														</td>
														<% } else { %>
														<td><label class="badge badge-gradient-success">이송출고</label>
														</td>
														<% } %>
