					...
					<div class="col-md-6 grid-margin stretch-card">
						<div class="card" style="width: 100%; min-width: 100%;">
							<div class="card-body" style="padding: 1.0rem 3.5rem;">
								<h3 class="card-title"
									style="margin-bottom: 50px; text-align: center; font-weight: bold">현재
									비밀번호와 새 비밀번호를 입력해주세요.</h3>
								<form class="forms-sample" action="" method="post">
									<input type="hidden" name="eCode"
										value="<%=request.getParameter("eCode")%>" />
									...
									<div style="text-align: center; margin-top: 50px">
										<button type="submit" class="btn btn-gradient-primary mr-2"
											onclick="return passwordValidate();">비밀번호 변경</button>
									</div>
								</form>
							</div>
						</div>
