					...
					<div class="col-md-6 grid-margin stretch-card">
						<div class="card" style="width: 100%; min-width: 100%;">
							<div class="card-body" style="padding: 1.0rem 3.5rem;">
								<h4 class="card-title"
									style="margin-bottom: 50px; text-align: center; font-weight: bold">내
									정보 보기</h4>
								<form class="forms-sample" action="" method="post">
									<input type="hidden" name="eCode" value="<%=emp.geteCode()%>" />
									<div class="form-group row">
										<label class="col-sm-3 col-form-label"><i
											class="mdi mdi-clipboard-account info"></i></label>
										<div class="col-sm-9">
									...
									<div class="form-group row">
										<label class="col-sm-3 col-form-label"><i
											class="mdi mdi-account info"></i></label>
										<div class="col-sm-9">
									...
									<div class="form-group row">
										<label class="col-sm-3 col-form-label"><i
											class="mdi mdi-lock info"></i></label>
										<div class="col-sm-9">
											<i class="fa fa-pencil" aria-hidden="true"
												data-toggle="tooltip" data-placement="top" title="비밀번호 수정"
												onclick="location.href='<%= request.getContextPath() %>/member/updatePassword?eCode=<%=user.geteCode()%>'"></i>
											</p>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-3 col-form-label"><i
											class="mdi mdi-city info"></i></label>
										<div class="col-sm-9">
											<p name="eDept" id="eDept"><%=emp.geteDept()%>팀
											</p>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-3 col-form-label"><i
											class="mdi mdi-cellphone info"></i></label>
										<div class="col-sm-9">
									...
									<div class="form-group row">
										<label class="col-sm-3 col-form-label"><i
											class="mdi mdi-email info"></i></label>
										<div class="col-sm-9">
