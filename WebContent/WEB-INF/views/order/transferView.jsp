			...
			<div class="content-wrapper">
				...
				<div style="padding-right: 20px;">
					<div
						...
						<h1 class="display-1 kor">이송 품의서</h1>
					</div>
					<div class="card"
						style="display: inline-block; margin-top: 26px; width: 250px; float: right">
				...
				<form class="forms-sample" name="stockFrom" id="stockForm"
											...
											<th>
												<form class="forms-sample">
													<div class="form-group">
														<label for="exampleInputUsername1">상품코드</label> <input
															type="text" class="form-control"
															value="<%=t == null ? "" : t.getpCode()%>" readonly>
													</div>
													<div class="form-group">
														<label for="exampleInputUsername1">수량 (개)</label> <input
															type="text" class="form-control"
															value="<%=t == null ? "" : t.gettAmount()%>" readonly>
													</div>
													<div class="form-group">
														<label for="exampleInputUsername1">출고센터</label> <input
															type="text" class="form-control"
															value="<%=t.getDepartureCode().equals("TK") ? "대구센터" : "경기 광주센터"%>"
															readonly>
													</div>
													<div class="form-group">
														<label for="exampleInputUsername1">입고센터</label> <input
															type="text" class="form-control"
															value="<%=t.getDestinationCode().equals("TK") ? "대구센터" : "경기 광주센터"%>"
															readonly>
													</div>
												</form>
											</th>
					...
					<div class="card-body"
						style="text-align: right; padding: 0.25rem; padding-right: 30px;">
						<h6 class="kor">
