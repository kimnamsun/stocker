...
public class BoardDAO {
	...
	public List<Calendar> selectCalendar(Connection conn) {
		...
		try {
			...
			while (rset.next()) {
				Calendar c = new Calendar(rset.getString("title"), rset.getString("color"),
						rset.getString("start_date"), rset.getString("end_date"));
				list.add(c);
	...
	public List<BoardComment> selectCommentList(Connection conn, int boardNo) {
		...
		try {
			...
			while (rset.next()) {
				...
				BoardComment bc = new BoardComment(boardCommentNo, boardCommentLevel, boardCommentWriter,
						boardCommentContent, boardRef, boardCommentRef, boardCommentDate);
