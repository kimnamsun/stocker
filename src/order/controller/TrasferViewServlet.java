...
public class TrasferViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ((empLoggedIn == null) || !("관리자".equals(empLoggedIn.geteDept()) || "이송".equals(empLoggedIn.geteDept()))) {
		...
		request.getRequestDispatcher("/WEB-INF/views/order/transferView.jsp").forward(request, response);
	}
